...
- **Food Categories** — Understand which food types are most popular
- **Customer Ratings** — Analyze how restaurants are rated by customers
- **Restaurant Performance** — Compare restaurants on revenue, ratings, and delivery speed
